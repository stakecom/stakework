...
#ifndef STAKEWORK_SCRIPT_SCRIPT_H
#define STAKEWORK_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, StakeWork always counted CHECKMULTISIGs
...
#endif // STAKEWORK_SCRIPT_SCRIPT_H
