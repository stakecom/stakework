...
#ifndef STAKEWORK_SCRIPT_STANDARD_H
#define STAKEWORK_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CStakeWorkAddress
 */
...
#endif // STAKEWORK_SCRIPT_STANDARD_H
