...
StakeWorkUnits::StakeWorkUnits(QObject *parent):
    QAbstractListModel(parent),
    unitlist(availableUnits())
{
}

QList<StakeWorkUnits::Unit> StakeWorkUnits::availableUnits()
{
...
bool StakeWorkUnits::valid(int unit)
{
    switch(unit)
    {
        case XSW:
...
QString StakeWorkUnits::name(int unit)
{
    switch(unit)
    {
        case XSW: return QString("XSW");
...
QString StakeWorkUnits::description(int unit)
{
    switch(unit)
    {
        case XSW: return QString("Stakework");
...
qint64 StakeWorkUnits::factor(int unit)
{
...
int StakeWorkUnits::decimals(int unit)
{
    switch(unit)
    {
        case XSW: return 8;
...
QString StakeWorkUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool fPretty)
{
...
QString StakeWorkUnits::pretty(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
// appropriate.
QString StakeWorkUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return QString("%1 %2").arg(format(unit, amount, plussign, separators), name(unit));
}

QString StakeWorkUnits::prettyWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return QString("%1 %2").arg(pretty(unit, amount, plussign, separators), name(unit));
}

QString StakeWorkUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool removeTrailing)
{
...
bool StakeWorkUnits::parse(int unit, const QString &value, CAmount *val_out)
{
...
QString StakeWorkUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (StakeWorkUnits::valid(unit))
    {
        amountTitle += " ("+StakeWorkUnits::name(unit) + ")";
    }
    return amountTitle;
}

int StakeWorkUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant StakeWorkUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
...
CAmount StakeWorkUnits::maxMoney()
{
    return MAX_MONEY;
}
