...
#include <config/stakework-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatStakeWorkURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + StakeWorkUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatStakeWorkURI(info));
}
