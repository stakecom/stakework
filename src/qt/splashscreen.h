...
#ifndef STAKEWORK_QT_SPLASHSCREEN_H
#define STAKEWORK_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. StakeWork Core initialization
...
#endif // STAKEWORK_QT_SPLASHSCREEN_H
