...
#ifndef STAKEWORK_QT_WALLETFRAME_H
#define STAKEWORK_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, StakeWorkGUI *_gui = 0);
    ~WalletFrame();
...
#endif // STAKEWORK_QT_WALLETFRAME_H
