    ...
    mapper(0)
{
    ...
    ui->stakeworkAtStartup->setToolTip(ui->stakeworkAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->stakeworkAtStartup->setText(ui->stakeworkAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new StakeWorkUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->stakeworkAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openStakeWorkConfButton_clicked()
{
