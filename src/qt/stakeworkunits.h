...
#ifndef STAKEWORK_QT_STAKEWORKUNITS_H
#define STAKEWORK_QT_STAKEWORKUNITS_H
...
/** StakeWork unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StakeWorkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StakeWorkUnits(QObject *parent);

    /** StakeWork units.
      @note Source: https://en.stakework.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        // Base currencies
...
typedef StakeWorkUnits::Unit StakeWorkUnit;

#endif // STAKEWORK_QT_STAKEWORKUNITS_H
