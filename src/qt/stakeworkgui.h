...
#ifndef STAKEWORK_QT_STAKEWORKGUI_H
#define STAKEWORK_QT_STAKEWORKGUI_H
...
/**
  StakeWork GUI main class. This class represents the main window of the StakeWork UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class StakeWorkGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit StakeWorkGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~StakeWorkGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a stakework wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // STAKEWORK_QT_STAKEWORKGUI_H
