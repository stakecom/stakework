...
private:
    ...
    QLabel* viewLbl;
    StakeWorkPushButton* proposalsBtn;
    StakeWorkPushButton* paymentRequestsBtn;
    StakeWorkPushButton* consultationsBtn;
    StakeWorkPushButton* deploymentsBtn;
    StakeWorkPushButton* consensusBtn;
    QLabel* filterLbl;
