 ...
 */
#ifndef STAKEWORK_UTIL_H
#define STAKEWORK_UTIL_H
...
extern const char * const STAKEWORK_CONF_FILENAME;
extern const char * const STAKEWORK_PID_FILENAME;
...
{
    std::string s = strprintf("stakework-%s", name);
