...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CStakeWorkAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CStakeWorkAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CStakeWorkAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CStakeWorkAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CStakeWorkAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CStakeWorkAddress(arr[0].get_str()).Get() == demoAddress.Get());
