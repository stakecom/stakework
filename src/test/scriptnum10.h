...
#ifndef STAKEWORK_TEST_SCRIPTNUM10_H
#define STAKEWORK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from StakeWork Core 0.10.0, for cross-comparison.
 */
public:
