...
#ifndef STAKEWORK_CONSENSUS_PARAMS_H
#define STAKEWORK_CONSENSUS_PARAMS_H
...
static std::string sDeploymentsDesc[Consensus::MAX_VERSION_BITS_DEPLOYMENTS] = {
    ...
    "Increase the contributed amount to the Community Fund to 0.5XSW per block",
    "NTP SYNC",
    "Upgrade to POSv3. Every staked block will have a fixed reward of 2 XSW",
...
#endif // STAKEWORK_CONSENSUS_PARAMS_H
