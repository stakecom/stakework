...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "StakeWork genesis block";
...
public:
    CMainParams() {
        ...
        consensus.nStakeMinAge = 60 ;	// minimum for coin age: 2 hours
        ...
        consensus.vParameters[Consensus::CONSENSUS_PARAM_XSWNS_FEE].value = 100 * COIN;
      ...
      // Deployment of Cold Staking Pool Fee
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "45.249.244.140"));
        vSeeds.push_back(CDNSSeedData("seed2", "107.150.124.67"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("teststakework.org", "testseed.stakework.org"));
...
public:
    CDevNetParams() {
        ...
        // 6) Generate first block using RPC command "./stakework-cli generate 1"
        ...
        vSeeds.push_back(CDNSSeedData("devnet.stakework.org", "devseed.stakework.org"));
