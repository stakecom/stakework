...
maintained:
* for `src/secp256k1`: https://github.com/stakework-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/stakework-core/leveldb.git (branch stakework-fork)
* for `src/univalue`: https://github.com/stakework-core/univalue.git (branch master)
...
stakework/stakework repository.
...
Configuring the github-merge tool for the stakework repository is done in the following way:
    ...
    git config githubmerge.repository stakework/stakework
...
A script to optimize png files in the stakework
