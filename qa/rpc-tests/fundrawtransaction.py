...
class RawTransactionsTest(StakeWorkTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid stakework address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid stakework address" in e.error['message'])
