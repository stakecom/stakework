...
class WalletTest (StakeWorkTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XSW from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 XSW with subtract fee from amount
        ...
        # Sendmany 10 XSW with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/stakework/stakework/issues/7463
        #     # '-salvagewallet',
        # ]
