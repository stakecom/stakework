...
unlocked to sign the StakeWork-Qt.app bundle.
...
allowing somebody to distribute a StakeWork-Qt.app or stakework-qt-setup.exe with a valid
...
that the stakework-qt.exe file inside the installer had not been tampered with.
